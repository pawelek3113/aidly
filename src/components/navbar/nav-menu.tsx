...
export const NavMenu = () => {
  ...
  return (
    <DialogPortal>
      ...
      >
        <div className="bg-chocolate border-chocolate-border grid h-16 w-full min-w-fit grid-cols-3 items-center justify-center gap-4 rounded-t-4xl border-x-4 border-t-4 mask-[linear-gradient(to_bottom,black_60%,transparent_100%)] px-4 py-2 [-webkit-mask-image:linear-gradient(to_bottom,black_60%,transparent_100%)]">
